(function (global, factory) {
    ...
    var tncode = {
        ...
        _block_start_move:function(e){
            ...
            e.preventDefault ? e.preventDefault() : theEvent.returnValue = false;
            if(theEvent.touches){
        ...
        _send_result:function(){
            ...
            var re = new _ajax();
            re.request('get',tncode._currentUrl()+'/Demo/SlideCaptcha/Check?tn_r='+tncode._mark_offset,haddle);
        },
        ...
        refresh:function(){
            ...
            var img_url = tncode._currentUrl()+"/Demo/SlideCaptcha/GetCode";
        ...
        getValidate:function () {
            return {"geetest_challenge":tncode._mark_offset, "geetest_validate":tncode._result, "geetest_seccode":tncode._result};
        },
        reset:function () {
            tncode.verify();
            return this;
    ...
    var initTncode = function(){
        tncode.init();
        return tncode;
    }
    window.initTncode = initTncode;
    return initTncode;
});
